...
class JobParameter:
    DISCOVER_DEVICE_GROUP = 'discoverDeviceGroup'
...
def DiscoveryMain(Framework):
    ...
    discoverDeviceGroup = _getBooleanParameter(JobParameter.DISCOVER_DEVICE_GROUP, Framework, True)
    logger.debug('discoverDeviceGroup: ', discoverDeviceGroup)
    ...
    try:
        try:
            ...
            discoverer.setDicoverDeviceGroupConfig(discoverDeviceGroup)
            ...
            if discoverResult:
                devicesById,connectivitiesByDeviceId,deviceGroups = discoverResult
                ...
                reporter.report(devicesById, connectivitiesByDeviceId,deviceGroups)
