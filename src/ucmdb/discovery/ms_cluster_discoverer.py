...
class ClusterCmd:
    ...
    def getClusterByPowerShell(self):
        ...
        if output:
            ...
            logger.reportWarning("Can not get cluster")
            return None
    ...
    def parsePowerShellEncodeOutput(self, content):
        ...
        if content.find("The specified module 'FailoverClusters' was not loaded") != -1:
            logger.reportWarning("The cluster service is not running or this is not a cluster")
        if match:
