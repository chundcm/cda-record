...
class WmiInterfaceDiscoverer(BaseInterfaceDiscoverer):
    ...
    def getNetworkAdapters(self):
        ...
        queryBuilder.addWmiObjectProperties('DeviceID', 'Name', 'NetConnectionID', 'Speed')
        ...
        for interfaceInfo in results:
            ...
            interface.alias = interfaceInfo.NetConnectionID
    ...
    def getInterfaces(self):
        ...
        if interfaces:
            for interface in interfaces:
                ...
                interface.alias = ifaceAddInfo and ifaceAddInfo.alias
        if not interfaces:
            raise ValueError("Failed getting interfaces")
        return interfaces
