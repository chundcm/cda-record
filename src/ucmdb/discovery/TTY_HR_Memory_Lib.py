...
def disAIX(hostId, shell, Framework = None, langBund = None, hostOsh= None):
...
def disHPUX(hostId, shell, Framework = None, langBund = None, hostOsh=None):
...
def disFreeBSD(hostId, shell, Framework = None, langBund = None, hostOsh= None):
...
def disVMKernel(hostId, shell, Framework = None, langBund = None, hostOsh= None):
...
def disLinux(hostId, shell, Framework = None, langBund = None, hostOsh= None):
...
def disSunOS(hostId, client, Framework = None, langBund = None, hostOsh= None):
...
def disWinOS(hostId, shell, Framework, langBund, hostOsh= None):
