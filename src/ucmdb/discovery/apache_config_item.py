...
class ConfigItem(object):
    ...
    def __init__(self, name, value=None, block=None):
        ...
        self.__root = None    # root block of this config item, initialize when first used
        self.__parents = None    # all parent blocks of this config item, initialize when first used
        self.__global_attributes = {}
    ...
    @property
    def parents(self):
        """all parent blocks of this config item"""
        if self.__parents:
    ...
    def getGlobalAttributes(self):
        return self.__global_attributes

    def setGlobalAttributes(self, global_attributes):
        self.__global_attributes = global_attributes

    globalAttributes = property(getGlobalAttributes, setGlobalAttributes)
    ...
    def appendChild(self, *items):
        ...
        for item in items:
            if isinstance(item, ConfigItem):
                item.block = self
                item.globalAttributes = self.globalAttributes
...
class IncludeProperty(Property):
    ...
    def __loadFile(self, shell, path):
        ...
        # store include history on globalAttributes
        included_files = self.globalAttributes.setdefault('included', [])
...
class ServerRootProperty(Property):
    ...
    def setServerRootInRootBlock(self):
        self.globalAttributes['server_root'] = self.server_root
