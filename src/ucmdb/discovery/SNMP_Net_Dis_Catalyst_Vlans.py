...
class JuniperVlanDiscoverer(VlanDiscoverer):
    VLAN_TABLE_MIB = '1.3.6.1.4.1.2636.3.40.1.5.1.5.1.2,1.3.6.1.4.1.2636.3.40.1.5.1.5.1.3,string'
    PORT_VLAN_TABLE_MIB = '1.3.6.1.4.1.2636.3.40.1.5.1.5.1.4,1.3.6.1.4.1.2636.3.40.1.5.1.5.1.5,string'
...
def DiscoveryMain(Framework):
    ...
    try:
        ...
        elif device_type_str.find('juniper') != -1:
            vlan_discoverer = JuniperVlanDiscoverer(snmpClient, hostOSH, Framework)
            try:
