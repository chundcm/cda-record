...
def _establish_connection(framework, config):
    ...
    sapSystemCredentialsId = config.sapSystemCredentialsId
    stored_credential = sapSystemCredentialsId or creds_id
    properties.setProperty('credentialsId', stored_credential)
    if inst_nr:
