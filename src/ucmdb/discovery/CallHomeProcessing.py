...
CALLHOME_ADAPTERS_LIST = ['InventoryDiscoveryByScanner', 'InstallUDAgent', 'UpdateUDAgent', 'UninstallUDAgent', 'BasicInventoryDiscoveryByScanner', 'AdvancedInventoryDiscoveryByScanner']
