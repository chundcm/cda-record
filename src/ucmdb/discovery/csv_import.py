...
class CsvFileDataSource(FileDataSource):
    ...
    """
    def __init__(self, csvFileName, delimiter, rowToStartIndex, Framework, fileEncoding=None, isBinaryMode=True):
        FileDataSource.__init__(self, csvFileName, Framework, fileEncoding, isBinaryMode)
...
def DiscoveryMain(Framework):
    ...
    try:
        ...
        isBinaryMode = Framework.getParameter(import_utils.PARAM_BINARY_MODE).lower() == 'true'

        dataSource = CsvFileDataSource(csvFileName, delimiter, int(rowToStartIndex), Framework, fileEncoding, isBinaryMode)
