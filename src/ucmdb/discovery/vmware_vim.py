...
class GlobalConfig:
    ...
    PATTERN_PARAM_IGNORE_HOSTS_WITHOUT_HOSTNAMES = "ignoreHostsWithoutHostNames"
    ...
    def __init__(self, framework):
        ...
        self._reportHostsWithoutHostnames=self._parseBoolean(framework.getParameter(GlobalConfig.PATTERN_PARAM_IGNORE_HOSTS_WITHOUT_HOSTNAMES), 0)
        if self._reportHostsWithoutHostnames:
            logger.debug("Ignore hosts without host names")
    ...
    def ignoreHostsWithoutHostnames(self):
        return self._reportHostsWithoutHostnames
...
_moduleByApiVersion = {
    ...
    _PatternMatcher(r"6\.5") : _vmware_vim_41,
    _PatternMatcher(r"6\.7"): _vmware_vim_41,
}
