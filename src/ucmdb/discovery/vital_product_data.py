...
class Discoverer(object):
    ...
    *parse_fc_vpd
    ...
    def parse_fc_vpd(lines):
        ...
        name = platform_specific_attrs.get('Name')
        model = platform_specific_attrs.get('Model')
        node = platform_specific_attrs.get('Node')
        device_type = platform_specific_attrs.get('Device Type')
        physical_location = platform_specific_attrs.get('Physical Location')
