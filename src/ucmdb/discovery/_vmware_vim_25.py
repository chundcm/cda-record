...
class VmCreatedOrChangedEventListener(_vmware_vim_20.VmCreatedOrChangedEventListener):
    def __init__(self, client, crossClientHelper):
        _vmware_vim_20.VmCreatedOrChangedEventListener.__init__(self, client, crossClientHelper)
...
class VmCreatedOrChangedEventReporter(_vmware_vim_20.VmCreatedOrChangedEventReporter):
    def __init__(self, crossClientHelper, framework):
        _vmware_vim_20.VmCreatedOrChangedEventReporter.__init__(self, crossClientHelper, framework)
