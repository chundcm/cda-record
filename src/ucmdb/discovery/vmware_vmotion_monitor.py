    ...
    try:
        ...
        try:
            ...
            if client:
                ...
                VmCreatedOrChangedEventListener = module.getVmCreatedOrChangedEventListener(agent, crossClientHelper)
                VmCreatedOrChangedEventReporter =  module.getVmCreatedOrChangedEventReporter(crossClientHelper, Framework)
                VmCreatedOrChangedEventListener._addReporter(VmCreatedOrChangedEventReporter)
                monitor.addListener(VmCreatedOrChangedEventListener)
