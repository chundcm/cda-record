...
class ApplicationTopologyReporter(BaseTopologyReporter):
    ...
    def _reportWebModules(self, container, modules):
        ...
        for module in modules:
            ...
            for webService in filter(lambda w: isinstance(w, WebService), webServices):
    ...
    def _reportApplications(self, container, *applications):
        ...
        # This is used for ASM to report applications by SCP
        self.applicationTopology.append((container, applications))
