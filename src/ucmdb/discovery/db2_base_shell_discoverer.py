...
def __get_configured_db2_cmd(shell_interpreter, instance_name,
    ...
    if db2_home_path and not shell_interpreter._shell.isWinOs():
        shell_interpreter._shell.execCmd(". %s/db2profile" % db2_home_path)
...
get_configured_db2_cmd = __get_configured_db2_cmd
