...
def DiscoveryMain(Framework):
    ...
    try:
        ...
        OracleHomePath = Framework.getParameter('OracleHomePath') or None
        shellUtils = None
        try:
            ...
            if OracleHomePath:
                customerPaths = OracleHomePath.split(';')
                discoveredOracleHomes = discoveredOracleHomes + customerPaths
            logger.debug('Oracle Homes from running processes and manual setting: %s' % discoveredOracleHomes)
