...
VALUES = ["IsAutoClose","Recovery","IsAutoShrink","cmptlevel","IsAutoUpdateStatistics","IsAutoCreateStatistics","IsReadOnly","Collation"]
...
class SqlDbProps:
    ...
    def __genAdditionalFilter(self):
        ...
        result = ""
        for prefix_len in sorted(group_prefixes_by_len.keys(), reverse=True):
        ...
        for dbName in databases.keySet():
            if dbName:
                ...
                try:
                    ...
                    logger.debugException("Failed to get Stored Procedure from database")
        return result
