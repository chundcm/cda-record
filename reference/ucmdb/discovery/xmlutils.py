...
def pyobj_printer(pyObj, level=0):
    ...
    if level == 0:
        descript = '-----* ' + pyObj.__class__.__name__ + ' *-----\n'
    else:
        descript = ''
...
def getXmlSecurityUtil():
    from com.hp.ucmdb.discovery.library.common import XmlSecurityUtil
    return XmlSecurityUtil
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        for filename in sys.argv[1:]:
            ...
            print
            pyobj_printer(pyObj).encode('UTF-8')
    else:
        print
        "Please specify one or more XML files to Objectify."
#
## Create a "factory object"
# xml_object = Serializer("/home/ekondrashev/svn_atlanta/ddmcontent_cp9_branch/assets9/discovery/discovery-packages/personal/main/static_content/Network/Traffic/TCP_discovery/discoveryConfigFiles/tcpDiscoveryDescriptor.xml")
## Create two different objects with recursively equal values
# py_obj1 = xml_object.makeInstance()
# print py_obj1
