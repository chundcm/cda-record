from arxview_mapping_interfaces import Mapping, LinkMapping, Link, Validator, InvalidValueException
from arxview_mapping_interfaces import CiMapping, AttributeMapping
import logger
...
class SimpleCiMapping(CiMapping):
    def __init__(self, sourceType, targetType, query, ref, base, idKey, parentType, parentQuery, **kwargs):
        ...
        self.__parentQuery = parentQuery
    ...
    def getParentQuery(self):
        return self.__parentQuery
...
class ReferenceLinkMapping(SimpleLinkMapping):
    def __init__(self, type, targetLinkName, sourceCi1Name, sourceCi2Name, referenceAttribute, targetCi1Name,
             targetCi2Name, direction, failurePolicy, isContainer, source_mapping_type, mapping_attribute ):
        ...
        self.__isContainer = isContainer
        self.__sourceMappingType = source_mapping_type
        self.__mappingAttribute = mapping_attribute
    ...
    def getSourceMappingType(self):
        return self.__sourceMappingType
    
    def getMappingAttribute(self):
        return self.__mappingAttribute
