...
AGENT_DRIVEN_OPERATING_AGENT_ENCOUNTERED_IN_OLD_FLOW = 505
...
# Errors used in ASM only
ERROR_CREDENTIAL = 251
MEET_LOAD_BALANCER = 252
NOT_SUDO = 253
NO_LSOF_INSTALL = 254
SOLARIS_LOCALZONE = 255
NO_SCP_REPORTED_IN_CONFIGFILE = 256
NO_SIGNATURE_MATCHED_IN_CONFIGFILE = 257
