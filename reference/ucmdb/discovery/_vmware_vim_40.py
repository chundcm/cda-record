...
class TopologyReporter(_vmware_vim_25.TopologyReporter):
    ...
    def reportDvPortGroupPolicy(self, dvPortGroup, resultVector):
        if dvPortGroup and dvPortGroup.osh and dvPortGroup.defaultPortConfig:
            ...
            vlanID = dvPortGroupPolicyOsh.getAttributeValue('vlan_id')
            if vlanID is not None:
                dvPortGroup.osh.setIntegerAttribute('vlan_id', vlanID)
...
class VmCreatedOrChangedEventListener(_vmware_vim_25.VmCreatedOrChangedEventListener):
    def __init__(self, client, crossClientHelper):
...
class VmCreatedOrChangedEventReporter(_vmware_vim_25.VmCreatedOrChangedEventReporter):
    def __init__(self, crossClientHelper, framework):
