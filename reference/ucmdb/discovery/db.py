...
class OracleCDB(entity.HasName, entity.HasOsh):
    def __init__(self, name):
        entity.HasOsh.__init__(self)
        entity.HasName.__init__(self)
        self.setName(name)
    ...
    def __repr__(self):
        return r'db.OracleCDB("%s")' % self.getName()


class OraclePDB(entity.HasName, entity.HasOsh):
    ...
    def __repr__(self):
        return r'db.OraclePDB("%s")' % self.getName()
...
#         r'@types: db.Table, ObjectStateHolder -> ObjectStateHolder'
    ...
    def reportServerWithDatabasesFromAddress(self, dbServer, dependants=None):
        ...
        oshs.append(hostOsh)
        return server_osh, ipseOsh, database_oshs, hostOsh, oshs
