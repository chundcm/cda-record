    ...
    try:
        ...
        try:
            ...
            for probeRange in probeRanges:
                if (probeRange.getType().equals(RangeType.CLIENT) or probeRange.getType().equals('Client')):
                    SNMP_Connection_Utils.discoverClientInRange(Framework, client, probeRange, excludePatterns, reportFakeNode=True)
