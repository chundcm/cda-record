...
class ASMApplicationSignature(applications.ApplicationSignature):
    ...
    def _processApplicationComponents(self, applicationComponents, applicationsToReport):
        for applicationComponent in applicationComponents:
            resultsVector = applicationComponent.processApplicationComponent(applicationsToReport, self.framework_delegator)
...
class ASMApplicationComponent(applications.ApplicationComponent):
    ...
    def processApplicationComponent(self, applicationsToReport, framework_delegator):
        ...
        for application in self.applications:
            framework_delegator.setCurrentApplication(application)
            ...
            try:
                ...
                framework_delegator.sendObjects(applicationResultsVector)
