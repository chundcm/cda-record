...
class VmCreatedOrChangedEventListener(_vmware_vim_40.VmCreatedOrChangedEventListener):
...
class VmCreatedOrChangedEventReporter(_vmware_vim_40.VmCreatedOrChangedEventReporter):
