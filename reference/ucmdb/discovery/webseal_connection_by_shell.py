...
def reportWebSeal(host_id, credential_id):
    ...
    websealOsh = modeling.createOshByCmdbId('isam_web', host_id)
...
def DiscoveryMain(Framework):
    ...
    isam_ids = Framework.getTriggerCIDataAsList('webseal_id_list')
    errorsList = []
    ...
    if credential_id:
        ...
        for isam_id in isam_ids: 
            OSHVResult.addAll(reportWebSeal(isam_id, credential_id))
    else:
