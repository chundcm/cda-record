...
def wired(*args, **kwargs):
    ...
    def decorator_fn(original_fn):
        ...
        def wrapper(*args_, **kwargs_):
            ...
            try:
                result = original_fn(*args_, **kwargs_)
            except:
                logger.debugException("Fail to discover hana informations, check log for more informations.")
                logger.reportWarning("Fail to discover hana informations, check log for more informations.")
            return result
        return wrapper
    return decorator_fn
